...
window.addEventListener('DOMContentLoaded', () => {
    ...
    next.addEventListener('click', () => {
        ...
        changeDotOpacity(slideIndex, dots);
    });
    ...
    prev.addEventListener('click', () => {
        ...
        updateSlideIndexText(current, slideIndex, slides);
    ...
    function updateSlideIndexText(current, slideIndex, slides) {
        if (slides.length < 10) {
            current.textContent = `0${slideIndex}`;
        } else current.textContent = slideIndex;
    }

    function changeDotOpacity(slideIndex, dots) {
